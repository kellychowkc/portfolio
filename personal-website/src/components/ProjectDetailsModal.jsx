          ...
          >
            <div className="modal-body">
              ...
              >
                <h2
                  className={
                    "text-7 font-weight-600 text-center mb-4" +
                ...
                <div className="row g-4">
                  <div className="col-md-7 imageBox">
                  ...
                  <div className="col-md-5">
                    ...
                    <ul
                      className={
                        "points " + (darkTheme ? "list-style-light" : "")
                      }
                    >
                     {projectDetails?.hightlights.map((point) => (
                             <li>
                             <span
                               className={
                    ...
                    >
                      ...
                      <li>
                        ...
                        <a
                          href={projectDetails?.gitUrl?.gitLink}
                          target="_blank"
                          rel="noopener noreferrer"
                        >
                          {projectDetails?.gitUrl?.gitName}
                        </a>
                      </li>
                    </ul>
