    ...
    >
      <div className={"container " + (classicHeader ? "" : "px-lg-5")}>
        ...
        <div className="row gy-5">
          {/* contact details */}
          <div className="order-1 order-md-0 text-center">
            ...
            <p className={"text-4 mb-4 " + (darkTheme ? "text-light" : "")}>
              <span className="text-primary text-5 me-3">
                <i className="fas fa-envelope" />
              </span>
              kellychowkc.kc@gmail.com
            </p>
            {/* <h2
              className={
            ...
            >
              ...
              <li className="social-icons-github ">
                <Tooltip text="Github" placement="top" >
                  <a
                    href="https://github.com/kellychowkc"
                    target="_blank"
                    rel="noopener noreferrer"
              ...
              <li className="social-icons-linkedin">
                <Tooltip text="Linkedin" placement="top">
                  <a
                    href="https://www.linkedin.com/in/kellychowkc/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="socialIcon"
                  >
